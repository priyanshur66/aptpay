  ...
  return (
    <div>
      <div className="text-center flex justify-center flex-col">
        {!user ? (
          <button
            className="flex items-center mt-24 mb-10 justify-center border px-4 py-2 rounded-lg bg-white text-gray-700 hover:bg-gray-100"
          ...
          >
            ...
            >
              <path
                fill="#4285F4"
                d="M24 9.5c2.2 0 4.2.8 5.8 2.3l4.3-4.3C30.8 5 27.5 4 24 4 14.9 4 7.5 10.9 6 19.5l5.9 4.6c.8-5.5 5.5-9.6 12.1-9.6z"
              />
              <path
                fill="#34A853"
                d="M24 44c5.5 0 10-1.8 13.4-4.8l-6.1-4.7c-1.7 1.2-3.8 1.9-7.3 1.9-5.7 0-10.5-3.8-12.2-9l-6 4.6C10.1 39.9 16.6 44 24 44z"
              />
              <path
                fill="#FBBC05"
                d="M43.6 24.5c0-1.1-.1-2.2-.3-3.2H24v6.3h11.1c-.5 2.5-2 4.6-4.2 6l6.1 4.7c3.6-3.3 6-8.1 6-13.8z"
              />
              <path
                fill="#EA4335"
                d="M12.5 28.8c-.4-1.2-.6-2.5-.6-3.8s.2-2.6.6-3.8l-6-4.6C5.2 19.6 4.5 22.2 4.5 25s.7 5.4 2 7.6l6-4.6z"
              />
            </svg>
            Sign in with Google
          </button>
